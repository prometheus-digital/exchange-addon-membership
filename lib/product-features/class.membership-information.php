...
class IT_Exchange_Addon_Membership_Product_Feature_Membership_Information {
	...
	*/
	function register_metabox() {
		add_meta_box( 'it-exchange-product-membership-information', __( 'Membership Information', 'LION' ), array( $this, 'print_metabox' ), 'it_exchange_prod', 'it_exchange_advanced' );
	}
	...
	*/
	function print_metabox( $post ) {
		...
		echo '<p><label for="it-exchange-membership-information-intended-audience-template" class="customer-information-label">' . $defaults['membership-intended-audience-label'] . ' <span class="tip" title="' . __('This label will appear when displaying the intended audience information on a membership.', 'LION' ) . '">i</span></label></p>';
		...
		echo '<p><label for="it-exchange-membership-information-objectives-template" class="customer-information-label">' . $defaults['membership-objectives-label'] . ' <span class="tip" title="' . __('This label will appear when displaying the objective information on a membership.', 'LION' ) . '">i</span></label></p>';
		...
		echo '<p><label for="it-exchange-membership-information-prerequisites-template" class="customer-information-label">' . $defaults['membership-prerequisites-label'] . ' <span class="tip" title="' . __('This label will appear when displaying the prerequisite information on a membership.', 'LION' ) . '">i</span></label></p>';
