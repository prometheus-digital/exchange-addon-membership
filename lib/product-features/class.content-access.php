...
class IT_Exchange_Addon_Membership_Product_Feature_Content_Access {
	...
	function __construct() {
		...
		add_action( 'it_exchange_update_product_feature_membership-content-access-rules', array(
			$this,
			'save_feature'
		), 9, 3 );
		add_filter( 'it_exchange_get_product_feature_membership-content-access-rules', array(
			$this,
			'get_feature'
		), 9, 3 );
		add_filter( 'it_exchange_product_has_feature_membership-content-access-rules', array(
			$this,
			'product_has_feature'
		), 9, 2 );
		add_filter( 'it_exchange_product_supports_feature_membership-content-access-rules', array(
			$this,
