jQuery(document).ready(function($) {
	...
	$( '.it-exchange-membership-addon-ungroup-content-access-group' ).on('click', function( event ) {
		event.preventDefault();
	...
	$( '.group-layout' ).on( 'click', function( event ) {
		var parent = $( this ).parent();
		type = $( this ).data( 'type' );
	...
	$( '.it-exchange-membership-addon-group-action-wrapper' ).hover( function() {
