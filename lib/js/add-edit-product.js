jQuery(document).ready(function($) {
	...
	$( '#it-exchange-product-membership-content-access-rules' ).on( 'click', '.it-exchange-membership-content-access-add-new-rule', function( event ) {
	...
	$( '#it-exchange-product-membership-content-access-rules' ).on( 'change', '.it-exchange-membership-content-type-selections', function() { //not working with .on
	...
	$( '#it-exchange-product-membership-content-access-rules' ).on('click', '.it-exchange-membership-addon-remove-content-access-rule, .it-exchange-membership-addon-remove-content-access-group', function( event ) { //not working with .on
		event.preventDefault();
	...
	$( '#it-exchange-product-membership-content-access-rules' ).on('click', '.it-exchange-membership-addon-ungroup-content-access-group', function( event ) {
		event.preventDefault();
	...
	$( '#it-exchange-product-membership-content-access-rules' ).on( 'click', '.it-exchange-membership-content-access-add-new-group', function( event ) {
		event.preventDefault();
		var data = {
	...
	$( '#it-exchange-product-membership-content-access-rules' ).on( 'click', '.group-layout', function( event ) {
	...
	$( '#it-exchange-product-membership-content-access-rules' ).on({
		mouseenter: function() {
	...
	$( '#it-exchange-product-membership-content-access-rules' ).on('click', '.it-exchange-membership-hierarchy-add-child a', function( event ) {
		event.preventDefault();
		var data = {
	...
	$( '#it-exchange-product-membership-content-access-rules' ).on('click', '.it-exchange-membership-hierarchy-add-parent a', function( event ) {
		event.preventDefault();
		var data = {
	...
	$( '#it-exchange-product-membership-content-access-rules' ).on('click', '.it-exchange-membership-addon-delete-membership-child, .it-exchange-membership-addon-delete-membership-parent', function( event ) {
		event.preventDefault();
