jQuery(document).ready(function($) {
	...
	$( '#it-exchange-product-membership-hierarchy' ).on('click', '.it-exchange-membership-hierarchy-add-child a', function( event ) {
		event.preventDefault();
		var data = {
	...
	$( '#it-exchange-product-membership-hierarchy' ).on('click', '.it-exchange-membership-hierarchy-add-parent a', function( event ) {
		event.preventDefault();
		var data = {
	...
	$( '#it-exchange-product-membership-hierarchy' ).on('click', '.it-exchange-membership-addon-delete-membership-child, .it-exchange-membership-addon-delete-membership-parent', function( event ) {
		event.preventDefault();
