jQuery(document).ready(function($) {
	$( '#it_exchange_membership_addon_membership_access_metabox' ).on( 'click', '.it-exchange-add-new-restriction', function( event ) {
	...
	$( '#it_exchange_membership_addon_membership_access_metabox' ).on( 'click', 'input.it-exchange-restriction-exceptions', function( event ) {
		var data = {
	...
	$( '#it_exchange_membership_addon_membership_access_metabox' ).on( 'click', '.it-exchange-membership-remove-new-rule', function( event ) {
		event.preventDefault();
		var parent = $( this ).parent();
		parent.remove();
	});
	
	$( '#it_exchange_membership_addon_membership_access_metabox' ).on( 'click', '.it-exchange-membership-remove-rule', function( event ) {
		event.preventDefault();
		var data = {
	...
	$( '#it_exchange_membership_addon_membership_access_metabox' ).on( 'click', '.it-exchange-add-new-restriction-ok-button', function( event ) {
		event.preventDefault();
		var parent = $( this ).parent();
		var data = {
	...
	$( '#it_exchange_membership_addon_membership_access_metabox' ).on('input keyup change', '.it-exchange-membership-drip-rule input.it-exchange-membership-drip-rule-interval', function(event) {
		event.preventDefault();
		var data = {
	...
	// Register Update Quantity event
	$( '#it_exchange_membership_addon_membership_access_metabox' ).on('change', '.it-exchange-membership-drip-rule select.it-exchange-membership-drip-rule-duration', function(event) {
		event.preventDefault();
		var data = {
